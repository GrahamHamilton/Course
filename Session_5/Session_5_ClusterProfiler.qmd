---
title: "Session 5: ClusterProfiler"
format:
  revealjs:
    slide-number: c/t
...
#| echo: true
#| eval: true
de_results <- read_delim("../Session_4/DESeq2/Treatment_vs_Control_results/Treatment_vs_Control.genes.tsv", 
                         delim = "\t")
```
...
Only implements over representation analysis.   
Supported organisms:
...
*   Use de genes from the GO gene set enrichment analysis
