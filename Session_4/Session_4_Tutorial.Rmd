...
Adapt the code above to get the lof fold shrunk results. Use the command lfcShrink(dds, coef = ...,  type = ...).
...
Volcano plot.
Below is a near complete code chunk for plotting a volcano plot of the unshrunkren results data. You will need to fill in the correct values wheere there are three dots (...).
...
vp <- ggplot(data =..., aes(x = ...,y = -log10(...))) +
  geom_point(aes(color = ...), size = 3/5)  +
...
Now try a heat map for this contrast
```{r contrast heatmap}
